...
<head>
  ...
  <title>Identity verified — Aus Fair Go</title>
</head>
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td align="center" style="padding-bottom:8px;">
                    <h1 style="margin:0;font-size:24px;font-weight:700;color:#1a2e23;letter-spacing:-0.5px;">Identity verified!</h1>
                  </td>
                </tr>
                ...
                <tr>
                  <td align="center" style="padding-bottom:32px;">
                    <p style="margin:0;font-size:15px;color:#5a6b60;line-height:1.6;">
                      ...
                      Your identity has been verified by our team. You now have a
                      <strong style="color:#1a2e23;">Verified</strong> badge displayed on your profile and complaints.
                    </p>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="border-top:1px solid #eee8dc;padding-top:24px;">
                    <p style="margin:0;font-size:13px;color:#8a9690;line-height:1.6;text-align:center;">
                      A verified badge builds trust with companies and shows your complaints are from a real, verified person.
                    </p>
                  </td>
                </tr>
