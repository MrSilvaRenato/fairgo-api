...
<head>
  ...
  <title>Identity verification update — Aus Fair Go</title>
</head>
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td align="center" style="padding-bottom:8px;">
                    <h1 style="margin:0;font-size:24px;font-weight:700;color:#1a2e23;letter-spacing:-0.5px;">Verification unsuccessful</h1>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="padding-bottom:24px;">
                    <div style="background:#fdf3f3;border:1px solid #f5c6c6;border-radius:12px;padding:16px 20px;">
                      <p style="margin:0;font-size:14px;color:#9b2c2c;line-height:1.6;">
                ...
                <tr>
                  <td align="center" style="padding-bottom:32px;">
                    <p style="margin:0;font-size:14px;color:#5a6b60;line-height:1.6;">
                      You can resubmit a clearer document (driver's licence, passport, or Medicare card) from your profile page.
                    </p>
                  </td>
                </tr>
