...
<head>
  ...
  <title>Reset your password — Aus Fair Go</title>
</head>
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td align="center" style="padding-bottom:24px;">
                    <div style="width:56px;height:56px;background:#fef3e2;border-radius:14px;display:inline-block;text-align:center;line-height:56px;font-size:26px;">🔐</div>
                  </td>
                </tr>
                ...
                <tr>
                  <td align="center" style="padding-bottom:8px;">
                    <h1 style="margin:0;font-size:24px;font-weight:700;color:#1a2e23;letter-spacing:-0.5px;">Reset your password</h1>
                  </td>
                </tr>
                ...
                <tr>
                  <td align="center" style="padding-bottom:32px;">
                    <p style="margin:0;font-size:15px;color:#5a6b60;line-height:1.6;">
                      Hi <strong style="color:#1a2e23;">{{ $name }}</strong>, we received a request to reset your Aus Fair Go password.<br/>
                ...
                <tr>
                  <td style="border-top:1px solid #eee8dc;padding-top:24px;">
                    <p style="margin:0;font-size:13px;color:#8a9690;line-height:1.6;text-align:center;">
                      This link expires in <strong>60 minutes</strong>. If you didn't request a password reset, you can safely ignore this email — your password won't change.
                    </p>
                  </td>
                </tr>
